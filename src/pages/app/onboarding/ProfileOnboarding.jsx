...
import { User, Briefcase, Building, MapPin, Camera, ArrowLeft, ArrowRight, CheckCircle } from 'lucide-react';
import { Button, Input, Select, Card, Icon, Alert } from '../../../components/ui';
...
const ProfileOnboarding = () => {
    ...
    // Dropdown data
    // const [countries, setCountries] = useState([]); // Removed as AddressForm handles it
    // const [regions, setRegions] = useState([]); // Removed as AddressForm handles it
    ...
    const saveProgress = async () => {
        ...
        try {
            ...
            // 1. Upsert Address if country_id is present
            if (formData.country_id) {
                const addressPayload = {
                    ...
                    nominatim_data: formData.nominatim_data || null,
            ...
            // 2. Update Profiles (Personal Info)
            ...
            if (addressId) {
                profileUpdates.address_id = addressId; // Use address_id, not primary_address_id
            }
            ...
            if ((formData.account_type === 'company' || formData.company_name || formData.vat_id) && profile.organization_id) {

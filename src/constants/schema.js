...
export const DATABASE_TABLES = [
    ...
    'subscription_plans', 'payment_method_icons', 'supported_locales', 'timezones',
...
export const TABLE_COLUMNS = {
    profiles: ['first_name', 'last_name', 'bio', 'about_me', 'professional_title', 'company_name', 'user_type'],
    ...
    supported_locales: ['name', 'native_name'],
    timezones: ['name', 'abbreviation'],
...
export const ALLOWED_LOOKUP_TABLES = [
    'countries', 'administrative_divisions', 'localities', 'regional_blocks',
    'supported_locales', 'timezones', 'subscription_plans', 'payment_method_icons'
];
...
export const LOOKUP_TABLE_CONFIG = {
    ...
    supported_locales: { orderBy: 'display_order', selectActive: true },
    timezones: { orderBy: 'name', selectActive: true },

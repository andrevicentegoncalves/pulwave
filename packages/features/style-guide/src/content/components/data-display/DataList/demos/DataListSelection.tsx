...
import { DataList, Badge, Text, Avatar, Icon, Button, Card, CircleFlag, Modal } from '@pulwave/ui';
...
const codeUsage = `// See DataListSelection.tsx for full implementation`;

export const DataListSelectionDemo = () => {
    ...
    return (
        <>
            <DemoCard sourceCode={codeUsage} showSourceToggle={true} title="Selectable DataList" description="Multi-select capability with counter. Click on an item to see details.">
                <Card className="demo-card-container">
                    <Card.Header>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%' }}>
                            <Text variant="h3">Team Members</Text>
                            <Text variant="small" color="muted">{selectedIds.length} selected</Text>
                        </div>
                    </Card.Header>
                    <Card.Body>
                        <DataList
